 ...
 */
final class Version20211027134007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE presentation (id INT AUTO_INCREMENT NOT NULL, title_left VARCHAR(255) NOT NULL, text_right LONGTEXT NOT NULL, title_right VARCHAR(255) NOT NULL, text_left LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
